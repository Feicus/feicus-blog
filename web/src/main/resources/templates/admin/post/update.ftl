        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form id="qForm" class="form-horizontal form-label-left" method="post" action="${base}/admin/post/update" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-right">公开状况</label>

                        <div class="col-sm-3">
                            <select class="form-control" name="isPublic" id="isPublic" data-required>
                                <#if view.isPublic==0>
                                    <option value="1">所有人可见</option>
                                    <option value="0" selected="selected">仅对自己可见</option>
                                <#else>
                                    <option value="1" selected="selected">所有人可见</option>
                                    <option value="0">仅对自己可见</option>
                                </#if>
                            </select>
                        </div>
                    </div>
