        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a href="${base}/index" class="navbar-brand">
                    <img src="${base}/dist/images/logo/logo.png" style="height: 50px;"/>
                </a>
            </div>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="${base}/user/profile"><i class="fa fa-user fa-fw"></i> 用户概况</a></li>
                        <li><a href="${base}/logout"><i class="fa fa-sign-out fa-fw"></i>注销</a></li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                <!-- /.dropdown -->
