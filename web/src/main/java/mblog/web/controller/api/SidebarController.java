...
public class SidebarController extends BaseController {
	...
	public @ResponseBody List<PostVO> latests() {
		...
		List<PostVO> rets = postService.findLatests(6, ignoreUserId,Consts.DELETE_DEFAULT);
		return rets;
	}
	...
	public @ResponseBody List<PostVO> hots() {
		...
		List<PostVO> rets = postService.findHots(6, ignoreUserId,Consts.DELETE_DEFAULT);
		return rets;
	}
