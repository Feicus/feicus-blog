...
public interface CommentDao extends JpaRepository<Comment, Long>, JpaSpecificationExecutor<Comment> {
	...
	Page<Comment> findAllByAuthorIdAndIsDeleteOrderByCreatedDesc(Pageable pageable, long authorId, int isDelete);

	Page<Comment> findAllByToIdAndIsDeleteOrderByCreatedDesc(Pageable pageable, long toId, int isDelete);
}
