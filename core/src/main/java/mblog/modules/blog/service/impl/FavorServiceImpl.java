...
public class FavorServiceImpl implements FavorService {
    ...
    @Override
    @Transactional
    public void updateDelete(long userId, long postId,int isDelete) {
        Favor po = favorDao.findByOwnIdAndPostId(userId, postId);
        Assert.notNull(po, "还没有喜欢过此文章");
    ...
    @Override
    public Page<FavorVO> pagingByOwnId(Pageable pageable, long ownId, int isDelete) {

        Page<Favor> page = favorDao.findAllByOwnIdAndIsDeleteOrderByCreatedDesc(pageable,ownId,isDelete);
